#Remember to dot source this file since powershell parses classes before add-types
...
class MainWindowViewModel : ViewModelBase {
    ...
    [void] OnPropertyChanged([string] $propertyName) {
        Write-Debug "Notified change of property '$propertyName'."
        #$this._propertyChanged.Invoke($this, $propertyName) # Why does this also work?
